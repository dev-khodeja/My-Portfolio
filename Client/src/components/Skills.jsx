...
const Skills = () => (
  <section className="skills" id="skills">
    <h2>Skills</h2>
    <ul>
      <li className="skill-mongo" style={{background: 'linear-gradient(90deg, #4DB33D, #1B5E20)'}}>MongoDB</li>
      <li className="skill-express" style={{background: 'linear-gradient(90deg, #222, #757575)'}}>Express.js</li>
      <li className="skill-react" style={{background: 'linear-gradient(90deg, #61dafb, #0a0e1a)'}}>React.js</li>
